...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#2E9E8F");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#3D1526");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#D9AFBF");   // concept border
  var C_TINT   = theme("--indigo-50", "#F7EDF1");     // concept fill
  var C_INK    = theme("--ink", "#2B1520");           // concept text
  var C_FAINT  = theme("--faint", "#DDCAD2");         // twig edges
